    ...
    case 0x2002:
      {
        ...
        // AJUSTE DE ALTURA PARA EL SCROLL (PS2):
        // Activamos el Sprite 0 Hit solo en la mitad inferior de la pantalla (línea 130 a 240).
        // Esto reordena correctamente el título abajo y el menú arriba.
        if (current_frame_line >= 130 && current_frame_line < 240)
        //if (current_frame_line >= 130 && current_frame_line < 240)
        {
          LowRegs[2] |= 0x40;
        }
