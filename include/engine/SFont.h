...
typedef struct {
	...
	int CharPos[512];
	int MaxPos;
	unsigned int is_char_font;
    char *font_chars; //contiene los cracateres en el orden de cada bitmap
} SFont_Font;
...
//si es necesario que cada bitmap tenga el roden de sus caracteres diferenteas a acii
